            ...
            <div className="hidden md:flex items-center w-full p-3 gap-2">
                ...
                {/* <div className="flex items-center relative ml-auto">
                    <a className="flex items-center justify-center w-8 h-8 cursor-pointer rounded-[50%] shadow-tiny transition-all 
                                    ...
                                    hover:brightness-90">
                        <svg className="size-6 text-gray-600 dark:text-gray-400" xmlns="https://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                ...
                <div className="flex items-center relative">
                    <a className="flex items-center justify-center w-8 h-8 cursor-pointer rounded-[50%] shadow-tiny transition-all
                                    ...
                                    dark:border-slate-700
                                    hover:brightness-90">
                        <svg className="size-5 text-gray-600 dark:text-gray-400" xmlns="https://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
